...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var pdfs = ["oxford_guide_to_english_grammar.pdf","Countries Capitals Currencies.pdf"]
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SmartShiksha")
